...
export function Hero() {
    return (
        <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-32">
            ...
            <div className="absolute inset-0 z-0 bg-[linear-gradient(to_right,#09637e12_1px,transparent_1px),linear-gradient(to_bottom,#09637e12_1px,transparent_1px)] bg-[size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
        </section>
    );
}
